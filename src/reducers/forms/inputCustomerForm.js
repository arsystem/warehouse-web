const inputCustomerForm = (state = {
    ...
    switch(action.type){
        ...
        case "INPUT_CUSTOMER_FORM_SHOW_ERROR":
            return Object.assign({}, state, {
                isSuccess: false,
                isLoading: false,
                isError: true,
